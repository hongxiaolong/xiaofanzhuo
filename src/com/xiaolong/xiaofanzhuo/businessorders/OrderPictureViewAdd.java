...
public class OrderPictureViewAdd implements IViewAddAndEventSet {
	...
	public View addViewAndAddEvenet(final Context context, View convertView,
		...
		FileUtil.setImageSrc(holder.imageView,
				data.getString(CartDatabaseAdapter.COL_FOOD_IMG_URL));
		holder.textTitle.setText(data.getString(CartDatabaseAdapter.COL_FOOD));
		holder.textPrice.setText(data.getString(CartDatabaseAdapter.COL_PRICE)
				+ "元");

		final TextView quantityView = holder.textAmount;
		quantityView.setText(data.getString(CartDatabaseAdapter.COL_NUMBER));
		/*
		 * 增减按钮逻辑
		 */
		holder.buttonAdd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				data.putString(CartDatabaseAdapter.COL_NUMBER, String.valueOf(num));
